...
final class ShortcutItemView: NSView {
    ...
    func updateDisplayWithItem(_ item: ShortcutItem) {
        ...
        itemKeyLabel.stringValue = Shortcut.printableKeyEquivalent(forSpecialKey: item.keyEquivalent.unicodeScalars.first) ?? item.keyEquivalent
